      ...
      {!isXsScreen && (
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              <button
                onClick={() => handleChangepant(pant1, 145, 237, 336, 401)}
              >
                <img src={pant1} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant2, 171, 257, 286, 367)}
              >
                <img src={pant2} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant3, 187, 215, 260, 400)}
              >
                <img src={pant3} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant4, 43, 217, 544, 440)}
              >
                <img src={pant4} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant5, 185, 235, 265, 390)}
              >
                <img src={pant5} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant6, 182, 258, 271, 350)}
              >
                <img src={pant6} height="100px" width="100px" />
              </button>
              <button
                onClick={() => handleChangepant(pant7, 197, 242, 237, 375)}
              >
