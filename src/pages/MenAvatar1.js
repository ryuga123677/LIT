    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            <button
              onClick={() => handleChangepant(pant1, 84 - 110, 0, 455, 645)}
            >
              <img src={pant1} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant2, 171 - 110, 257, 286, 367)}
            >
              <img src={pant2} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant3, 187 - 110, 215, 260, 400)}
            >
              <img src={pant3} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant4, 43 - 110, 217, 544, 440)}
            >
              <img src={pant4} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant5, 185 - 110, 235, 265, 390)}
            >
              <img src={pant5} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant6, 182 - 110, 258, 271, 350)}
            >
              <img src={pant6} height="100px" width="100px" />
            </button>
            <button
              onClick={() => handleChangepant(pant7, 197 - 110, 242, 237, 375)}
            >
