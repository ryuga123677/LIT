...
import imgPath1 from "../common/assets/Avatar/malechar/Male R 02 croqui.png";
    ...
    <div style={{ display: "flex", flexDirection: "row",gap:20,flexWrap:"wrap",height:"100vh"}}>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", flexDirection: "row" , overflowX: "auto", maxWidth: "400px"}}>
          <button onClick={() => handleChangeshirt(shirt1,215, 102, 198, 204)}>
            <img src={shirt1} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt2, 217, 98, 194, 268)}>
          ...
          <button onClick={() => handleChangeshirt(shirt7, 202, 94, 231, 246)}>
            <img src={shirt7} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt8,215, 96, 200, 271)}>
            <img src={shirt8} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt9,199, 120, 223, 215)}>
            <img src={shirt9} height="100px" width="100px" />
          </button>
        
          <button onClick={() => handleChangeshirt(shirt11, 199, 120, 223, 215)}>
            <img src={shirt11} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt12,199, 120, 223, 215)}>
            <img src={shirt12} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt13, 230, 68, 170, 321)}>
            <img src={shirt13} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt14, 145, 72, 338, 292)}>
            <img src={shirt14} height="100px" width="100px" />
          </button>
          <button onClick={() => handleChangeshirt(shirt15, 202, 94, 231, 246)}>
