...
import p5 from "p5";
import imgPath from "../common/assets/Avatar/femalechar/Female croqui 2.png";
...
import imgPath3 from "../common/assets/Avatar/femalechar/femaleEye6.png";
...
import imgPath5 from "../common/assets/Avatar/femalechar/femalemouth7.png";
...
const Female1 = () => {
  ...
  const [hairScale, setHairScale] = useState({ width: 130, height: 175 });

  const [eyeImage, setEyeImage] = useState(imgPath3);
  const [eyePosition, setEyePosition] = useState({ x: 292, y: 73 });
  const [eyeScale, setEyeScale] = useState({ width: 79, height: 20 });
